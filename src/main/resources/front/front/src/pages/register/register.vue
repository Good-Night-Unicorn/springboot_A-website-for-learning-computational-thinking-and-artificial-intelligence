	...
	<div>
		...
		<div class="container">
			<el-form class='rgs-form animate__animated animate__' v-if="pageFlag=='register'" ref="registerForm" :model="registerForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot的计算思维与人工智能学习网站设计与实现</p></div>
					...
					<el-form-item class="list-item" v-if="tableName=='xuesheng'" prop="banji">
					...
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="laoshizhanghao">
						<div class="label" :class="changeRules('laoshizhanghao')?'required':''">老师账号：</div>
						<el-input v-model="registerForm.laoshizhanghao"  placeholder="请输入老师账号" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="laoshixingming">
						<div class="label" :class="changeRules('laoshixingming')?'required':''">老师姓名：</div>
						<el-input v-model="registerForm.laoshixingming"  placeholder="请输入老师姓名" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="mima">
						<div class="label" :class="changeRules('mima')?'required':''">密码：</div>
						<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="mima2">
						<div class="label" :class="changeRules('mima')?'required':''">确认密码：</div>
						<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="lianxifangshi">
					...
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="xingbie">
						<div class="label" :class="changeRules('xingbie')?'required':''">性别：</div>
						<el-select v-model="registerForm.xingbie" placeholder="请选择性别" >
							<el-option
					...
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="nianling">
						<div class="label" :class="changeRules('nianling')?'required':''">年龄：</div>
						<el-input v-model="registerForm.nianling"  placeholder="请输入年龄" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="jiaoshizhicheng">
						<div class="label" :class="changeRules('jiaoshizhicheng')?'required':''">教师职称：</div>
						<el-input v-model="registerForm.jiaoshizhicheng"  placeholder="请输入教师职称" />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'" prop="touxiang">
						<div class="label" :class="changeRules('touxiang')?'required':''">头像：</div>
						<file-upload
							tip="点击上传头像"
							action="file/upload"
	...
	mounted() {
		if(this.$route.query.pageFlag=='register'){
			...
			if ('laoshi' == this.tableName) {
				...
				this.requiredRules.laoshizhanghao = [{ required: true, message: '请输入老师账号', trigger: 'blur' }]
			}
			if ('laoshi' == this.tableName) {
				this.rules.laoshixingming = [{ required: true, message: '请输入老师姓名', trigger: 'blur' }];
				this.requiredRules.laoshixingming = [{ required: true, message: '请输入老师姓名', trigger: 'blur' }]
			}
			if ('laoshi' == this.tableName) {
				this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }];
				this.requiredRules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }]
