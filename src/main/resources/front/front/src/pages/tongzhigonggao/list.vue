		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.gonggaoleixing" placeholder="公告类型" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('tongzhigonggao','新增')" type="primary" @click="add('/index/tongzhigonggaoAdd')">
			...
			<div class="list">
				...
				<div class="list2 index-pv1">
					<div v-for="(item, index) in dataList" :key="index" class="list-item animation-box" @click.stop="toDetail(item)">
						<div class="img">
							<img @click.stop="imgPreView(item.gonggaotupian)" v-if="item.gonggaotupian && item.gonggaotupian.substr(0,4)=='http'&&item.gonggaotupian.split(',w').length>1" :src="item.gonggaotupian" class="image" />
							<img @click.stop="imgPreView(item.gonggaotupian.split(',')[0])" v-else-if="item.gonggaotupian && item.gonggaotupian.substr(0,4)=='http'" :src="item.gonggaotupian.split(',')[0]" class="image" />
							<img @click.stop="imgPreView(baseUrl + (item.gonggaotupian?item.gonggaotupian.split(',')[0]:''))" v-else :src="baseUrl + (item.gonggaotupian?item.gonggaotupian.split(',')[0]:'')" class="image" />
						</div>
						<div class="item-info">
