		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.laoshizhanghao" placeholder="老师账号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">老师姓名：</div>
					<el-input v-model="formSearch.laoshixingming" placeholder="老师姓名" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
					<div class="lable">教师职称：</div>
					<el-input v-model="formSearch.jiaoshizhicheng" placeholder="教师职称" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-button class="list-search-btn" v-if=" true " type="primary" @click="getList(1, curFenlei)">
					<i class="el-icon-search"></i>
					查询
				</el-button>
				<el-button class="list-add-btn" v-if="btnAuth('laoshi','新增')" type="primary" @click="add('/index/laoshiAdd')">
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.laoshizhanghao != '') searchWhere.laoshizhanghao = '%' + this.formSearch.laoshizhanghao + '%';
				if (this.formSearch.laoshixingming != '') searchWhere.laoshixingming = '%' + this.formSearch.laoshixingming + '%';
				if (this.formSearch.jiaoshizhicheng != '') searchWhere.jiaoshizhicheng = '%' + this.formSearch.jiaoshizhicheng + '%';
				let user = JSON.parse(localStorage.getItem('sessionForm'))
				if (this.sortType) searchWhere.sort = this.sortType
				if (this.sortOrder) searchWhere.order = this.sortOrder
				this.$http.get(`laoshi/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/laoshiDetail', query: params});
			},
