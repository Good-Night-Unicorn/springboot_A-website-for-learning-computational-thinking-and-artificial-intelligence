<template>
	...
	<!--  -->
		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="item">
						...
						<div class="text "  >{{detail.shiyongfanwei}}</div>
					</div>
					<div class="item">
			...
			<video v-if="detail.ziyuanshipin" ref="ziyuanshipin" :src="baseUrl +  detail.ziyuanshipin"  controls="controls"  controlsList="nodownload">
				您的浏览器不支持视频播放
			</video>

			<el-tabs class="detail-tabs" v-model="activeName" type="border-card" v-if="tabsNum>0" >
				<el-tab-pane label="资源简介" name="first">
