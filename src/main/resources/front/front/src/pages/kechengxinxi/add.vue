<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="课程附件" prop="kechengfujian">
				<file-upload
					tip="点击上传课程附件"
					action="file/upload"
					:limit="1"
			...
			<el-form-item class="add-item" label="课程课时" prop="kechengkeshi">
				<el-input v-model.number="ruleForm.kechengkeshi" 
	...
	export default {
		...
		methods: {
			...
			kechengfujianUploadChange(fileUrls) {
				this.ruleForm.kechengfujian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
			},
		}
	};
</script>
