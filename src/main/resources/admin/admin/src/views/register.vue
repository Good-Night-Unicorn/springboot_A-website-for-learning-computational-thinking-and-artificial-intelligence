	...
	<div>
		<div class="register-container">
			<el-form v-if="pageFlag=='register'" ref="ruleForm" class="rgs-form animate__animated animate__backInDown" :model="ruleForm" :rules="rules">
				<div class="rgs-form2">
					<div class="title">基于SpringBoot的计算思维与人工智能学习网站设计与实现</div>
					...
					<el-form-item class="list-item" v-if="tableName=='laoshi'">
						<div class="lable" :class="changeRules('laoshizhanghao')?'required':''">老师账号：</div>
						<el-input  v-model="ruleForm.laoshizhanghao"  autocomplete="off" placeholder="老师账号"  type="text"  />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'">
						<div class="lable" :class="changeRules('laoshixingming')?'required':''">老师姓名：</div>
					...
					<el-form-item class="list-item" v-if="tableName=='laoshi'">
						<div class="lable" :class="changeRules('jiaoshizhicheng')?'required':''">教师职称：</div>
						<el-input  v-model="ruleForm.jiaoshizhicheng"  autocomplete="off" placeholder="教师职称"  type="text"  />
					</el-form-item>
					<el-form-item class="list-item" v-if="tableName=='laoshi'">
						<div class="lable" :class="changeRules('touxiang')?'required':''">头像：</div>
						<file-upload
