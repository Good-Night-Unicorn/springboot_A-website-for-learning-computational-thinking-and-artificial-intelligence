<template>
	<div class="addEdit-block">
		...
		>
			...
			<el-form-item class="textarea" v-if="type!='info'" label="成绩寄语" prop="chengjijiyu" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.chengjijiyu" label="成绩寄语" prop="chengjijiyu" >
				<span class="text">{{ruleForm.chengjijiyu}}</span>
			</el-form-item>
