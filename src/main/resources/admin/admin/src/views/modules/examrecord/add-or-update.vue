<template>
	<div class="main-content" :style='{"padding":"20px 10px 20px 10px","fontSize":"15px"}'>
		<!-- 列表页 -->
		<div v-if="!showFlag">
			<el-form :style='{"border":"1px solid #BFBFBF","padding":"40px 30% 20px 10%","background":"#FFFFFF"}' :inline="true" :model="searchForm" class="add-update-preview">
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}' label="在线测试">
				...
				<el-form-item :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"0 0 26px 0","display":"inline-block"}'>
