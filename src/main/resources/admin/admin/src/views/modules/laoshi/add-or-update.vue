	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="教师职称" prop="jiaoshizhicheng" >
					<el-input v-model="ruleForm.jiaoshizhicheng" placeholder="教师职称" clearable  :readonly="ro.jiaoshizhicheng"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="教师职称" prop="jiaoshizhicheng" >
					<el-input v-model="ruleForm.jiaoshizhicheng" placeholder="教师职称" readonly></el-input>
				</el-form-item>
