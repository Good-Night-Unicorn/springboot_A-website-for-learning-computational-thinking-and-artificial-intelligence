	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.xuankeshijian" label="选课时间" prop="xuankeshijian" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="选课备注" prop="xuankebeizhu" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.xuankebeizhu" label="选课备注" prop="xuankebeizhu" >
				<span class="text">{{ruleForm.xuankebeizhu}}</span>
			</el-form-item>
